...
//                    if (projectExists)
//                    {
//                        var projectReader = new ProjectV1Reader();
...
//                    var projectWriter = new ProjectV1Writer();
...
//                            var repo = new SqlServerRepository("", null); //null;  new ModelHelper.Data.SqlServerRepository(project.DataSource.Connection, project);
...
//                                    var template = templateReader.Read(selectedTemplate.FileInfo.FullName, tpl.Name);
...
//                    //    DataSource = new ProjectSourceSectionV1 { Connection = "blank"},
