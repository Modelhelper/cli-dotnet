    ...
    public class Tetrominoe
    {
        ...
        public void Drop()
        {
            ...
            if (isSomethingBelow())
            {
                for (int i = 0; i < 4; i++)
                {
                    EasterEgg.droppedtetrominoeLocationGrid[location[i][0], location[i][1]] = 1;
                }
                EasterEgg.isDropped = true;
        ...
        public bool isSomethingBelow()
        {
            for (int i = 0; i < 4; i++)
            {
                ...
                if (location[i][0] + 1 < 23)
                {
                    if (EasterEgg.droppedtetrominoeLocationGrid[location[i][0] + 1, location[i][1]] == 1)
                    {
                        return true;
                    }
                }
        ...
        public bool? isOverlayBelow(List<int[]> location)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (ycoords.Max() - ycoords.Min() == 3)
                {
                    ...
                    {
                        if (EasterEgg.droppedtetrominoeLocationGrid[location[i][0], location[i][1]] == 1)
                        {
                            return true;
                        }
                    }
        ...
        public bool isSomethingLeft()
        {
            for (int i = 0; i < 4; i++)
            {
                ...
                else if (EasterEgg.droppedtetrominoeLocationGrid[location[i][0], location[i][1] - 1] == 1)
                {
                    return true;
                }
            }
        ...
        public void Update()
        {
            for (int i = 0; i < 23; i++)
            {
                for (int j = 0; j < 10; j++)
                {
                    EasterEgg.grid[i, j] = 0;
                }
            }
            for (int i = 0; i < 4; i++)
            {
                EasterEgg.grid[location[i][0], location[i][1]] = 1;
            }
            EasterEgg.Draw();
        }
    }
